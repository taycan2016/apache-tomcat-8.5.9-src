...
public abstract class AbstractEndpoint<S> {
    ...
    public void createExecutor() {
        /**
         * 创建一个 “任务队列”，实际上是一个继承了 LinkedBlockingQueue<Runnable> 的类。该队列最大长度为 int 最大值 0x7fffffff。
         * 创建一个线程工厂，TaskThreadFactory 是一个继承 ThreadFactory 的类，默认创建最小线程 10， 最大线程200， 名字为 “http-bio-8080-exec-” 拼接线程池编号，优先级为5。
    ...
    protected final void startAcceptorThreads() {
        ...
        //复杂的是 Acceptor 中的逻辑，
        // Acceptor 是一个抽象静态内部类，实现了 Runnable 接口，
        // AprEndpoint 类中也继承了该类，
        // 并实现了run方法如下(高能预警，方法很长)。
