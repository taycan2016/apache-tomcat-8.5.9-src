...
public final class Bootstrap {
    ...
    private void initClassLoaders() {
        try {
            ...
            // 初始化 catalinaloader 和 sharedLoader 两个类加载器
    ...
    public void init() throws Exception {
        ...
        paramValues[0] = sharedLoader;//分享类加载器
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            if (command.equals("startd")) {// 启动命令
                ...
                //初始化Servce.init() 初始化Service.init()
                daemon.load(args);
                daemon.start();
            } else if (command.equals("stop")) {    //停止命令
